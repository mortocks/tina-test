...
export const Hero = ({ data, parentField }) => {
  ...
  const placeholderText = [{ type: "heading1", text: data.headline }];
  ...
  return (
    <Section color={data.color} className="py-20">
      <Container
        size="large"
      ...
      >
                ...
                {placeholderText.map((item, index) => {
                  return (
                    <AnimatedText
                      ...
                      tag="h3"
                      color=""
                      className={`w-full relative	mb-10 text-6xl font-bold tracking-normal leading-tight font-serif mb-0`}
                    />
                  );
                })}
              </div>
        ...
        {data.image && (
          ...
          >
            <img
              className="w-full md:max-w-none h-auto"
              alt={data.image.alt}
              src={data.image.src}
            />
          </div>
...
export const heroBlockSchema: TinaTemplate = {
  ...
  ui: {
    ...
    defaultItem: {
      ...
      text: "This is where you body text will go",
    },
  },
  fields: [
    {
