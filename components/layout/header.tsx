...
export const Header = ({ data }) => {
  ...
  return (
    <div className={`z-50 fixed w-full top-0 bg-blue-500 left-0`}>
                ...
                return (
                  ...
                  >
                    <Link href={`${prefix}/${item.href}`} passHref>
                      <a className="select-none	text-base inline-block tracking-wide font-regular transition duration-150 ease-out opacity-70 hover:opacity-100 py-8 text-white">
                        {item.label}
                      </a>
                    </Link>
                  </li>
